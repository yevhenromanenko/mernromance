...
const FetchRequestCountInvite = async (setTodayCount, setMonthCount) => {
    try {
        ...
        const response = await axios.get(`https://${SERVER_NAME}/countinvites?id=${newId}`, {
            headers: {
...
export default FetchRequestCountInvite;
